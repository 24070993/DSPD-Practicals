...
6] Implement Binary search tree(BST) with following Menu operations. 1. Search an element in BST(Display NULL if not found, If found Display Found) 2. Insert an element in BST 3. Delete leaf element in BST 4. Exit
...
8] Write a Program to implement Kruskal's Algorithm in graph to find the Mininaum Spanning Tree (MST) of a connected, weighted, and undirected graph.
